...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-dark" style="width: 280px; height: 100%; z-index: 500;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item mb-3">
            <a href="/dashboardMediaBoss/?home=active"
        ...
        <li class="nav-item mb-3">
            <a href="/dashboardMediaBoss/members?membre=active"
        ...
        <li class="nav-item mb-3">
            <a href="/dashboardMediaBoss/projet?projet=active"
        ...
        <li class="nav-item mb-3" id="headerDiv">
            <a href="/dashboardMediaBoss/notification?notification=active"
